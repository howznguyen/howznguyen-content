...
<Callout type="note">
  Knowns should not turn a simple job into a heavier workflow. If it does, it
  is playing the wrong role.
</Callout>
...
<Quote color="blue">
  Do not FOMO into Knowns. Learn how to build a Second Brain for your system.
  If Knowns makes that easier for you, then use it.
</Quote>

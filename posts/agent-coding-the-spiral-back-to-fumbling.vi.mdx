...
Cái cảm giác khi ngồi với <TermNote id="agent">AI agent</TermNote> để làm một tính năng, nó giống hệt cách mình học lập trình hồi mới bắt đầu. Cách đây khoảng 10 năm.
...
Thực ra một số khuôn mẫu đã bắt đầu hình thành rồi. Agentic coding, <TermNote explanation="Spec-driven development là cách chốt hành vi và giới hạn bằng đặc tả trước khi bắt đầu làm.">spec-driven development</TermNote>, AI-assisted code review. Nhưng tất cả vẫn đang ở giai đoạn rất sớm. Chưa có "SOLID cho cách dùng AI". Chưa có "Clean Architecture cho prompting".

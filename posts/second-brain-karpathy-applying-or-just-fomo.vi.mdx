...
Mấy ngày gần đây mình thấy Twitter, Reddit, Hacker News, rồi cả mấy group dev ở Việt Nam đều nhắc tới một gist của **[Andrej Karpathy](https://karpathy.ai/)**. Nội dung là cách ổng tự xây một kiểu wiki cá nhân dùng <TermNote id="llm">LLM</TermNote> để quản lý kiến thức. Nhiều người gọi nó là "Second Brain kiểu Karpathy".
...
Ổng không muốn dùng <TermNote id="rag">**RAG**</TermNote> theo kiểu truyền thống: mỗi lần hỏi thì truy vấn tài liệu thô, nhồi ngữ cảnh vào prompt, rồi để model tổng hợp lại từ đầu. Cách đó có ích, nhưng nó không tạo ra nhiều kiến thức tích lũy. Mỗi lần hỏi gần như là một lần làm lại.
...
1. **Tạo đất của bạn**: một folder local hoặc GitHub <TermNote id="repository">repo</TermNote>. Đừng bắt đầu trong app đóng. Folder mới là nền tảng.

...
<figure>
  ...
  >
    <title id="stack-title">Làm chủ nền tảng kiến thức</title>
    <rect x="0" y="0" width="800" height="400" fill="#0f172a" rx="16" />
    <rect x="108" y="44" width="584" height="78" fill="#111827" fillOpacity="0.25" stroke="#334155" strokeWidth="2" strokeOpacity="0.75" rx="16" />
    <rect x="108" y="156" width="584" height="78" fill="#111827" fillOpacity="0.35" stroke="#a5b4fc" strokeWidth="2" strokeOpacity="0.8" rx="16" />
    <rect x="108" y="268" width="584" height="78" fill="#13251c" fillOpacity="0.95" stroke="#4ade80" strokeWidth="2" strokeOpacity="0.9" rx="16" />
    <line x1="400" y1="126" x2="400" y2="152" stroke="#334155" strokeWidth="2" strokeOpacity="0.8" />
    <path d="M392 136 L400 126 L408 136" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M392 142 L400 152 L408 142" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <line x1="400" y1="238" x2="400" y2="264" stroke="#334155" strokeWidth="2" strokeOpacity="0.8" />
    <path d="M392 248 L400 238 L408 248" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M392 254 L400 264 L408 254" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <text x="150" y="74" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="18" fontWeight="800" fill="#e2e8f0" style={{ fill: "#e2e8f0" }}>GIAO DIỆN</text>
    <text x="650" y="74" textAnchor="end" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="700" fill="#94a3b8" style={{ fill: "#94a3b8" }}>có thể thay</text>
    <text x="150" y="100" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="500" fill="#94a3b8" style={{ fill: "#94a3b8" }}>Obsidian · Cursor · Claude Code</text>
    <text x="150" y="186" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="18" fontWeight="800" fill="#a5b4fc" style={{ fill: "#a5b4fc" }}>NGƯỜI PHỤ VIỆC</text>
    <text x="650" y="186" textAnchor="end" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="700" fill="#94a3b8" style={{ fill: "#94a3b8" }}>có thể đổi</text>
    <text x="150" y="212" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="500" fill="#94a3b8" style={{ fill: "#94a3b8" }}>Claude · GPT · Gemini · local model</text>
    <text x="150" y="298" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="18" fontWeight="800" fill="#e2e8f0" style={{ fill: "#e2e8f0" }}>NỀN TẢNG</text>
    <text x="650" y="298" textAnchor="end" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="800" fill="#4ade80" style={{ fill: "#4ade80" }}>bạn sở hữu</text>
    <text x="150" y="324" dominantBaseline="middle" fontFamily="ui-monospace, monospace" fontSize="14" fontWeight="500" fill="#e2e8f0" style={{ fill: "#e2e8f0" }}>folder · markdown · GitHub · AGENTS.md</text>
    <text x="400" y="374" textAnchor="middle" dominantBaseline="middle" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="16" fontWeight="700" fill="#4ade80" style={{ fill: "#4ade80" }}>First Brain: hiểu · đọc kỹ · kiểm chứng</text>
  </svg>
</figure>

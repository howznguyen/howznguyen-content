...
<figure>
  <svg
    ...
    role="img"
    aria-labelledby="chat-vs-wiki-title"
    style={{ width: "100%", height: "auto", color: "#e2e8f0" }}
  >
    <title id="chat-vs-wiki-title">AI để suy nghĩ vs AI để xây kiến thức</title>
    <rect x="0" y="0" width="800" height="340" fill="#0f172a" rx="12" />
    <rect
      x="60"
      y="75"
      width="280"
    ...
    <text
      ...
      style={{ fill: "#4ade80" }}
    >
      tích lũy · nhân lên · làm chủ nền tảng
    </text>
    <text
      x="400"
      y="323"
      ...
      style={{ fill: "#e2e8f0" }}
    >
      Cùng một LLM, nhưng hai cách dùng tạo ra hai kiểu giá trị rất khác nhau.
    </text>
  </svg>
</figure>

<p align="center"><em>Chat là RAM, wiki là ổ cứng. Dùng AI để suy nghĩ và dùng AI để xây kiến thức là hai bài toán khác nhau.</em></p>
...
<figure>
  <svg
    ...
    style={{ width: "100%", height: "auto", color: "#e2e8f0" }}
  >
    <title id="stack-title">Own your substrate - kiến thức như một stack</title>
    <rect x="0" y="0" width="800" height="380" fill="#0f172a" rx="12" />
    <rect
      x="200"
      y="50"
      width="400"
    ...
    <text
      ...
      style={{ fill: "#e2e8f0" }}
    >
      Obsidian · Cursor · Claude Code · VS Code
    </text>
    <text
      x="400"
      y="120"
    ...
    <text
      ...
      style={{ fill: "#e2e8f0" }}
    >
      folder local · GitHub repo · Markdown · bộ quy tắc
    </text>
    <text
      x="400"
      y="350"
      ...
      style={{ fill: "#4ade80" }}
    >
      First Brain: hiểu · đọc kỹ · kiểm chứng · chọn lọc
    </text>
    <text
      x="25"
      y="144"
    ...
    <text
      ...
      style={{ fill: "#e2e8f0" }}
    >
      càng lên trên càng dễ đổi · càng xuống dưới càng phải sở hữu
    </text>
  </svg>
</figure>

<p align="center"><em>Markdown có cấu trúc - đủ đơn giản cho người, đủ rõ ràng cho AI. Làm chủ nền tảng kiến thức, còn công cụ thì có thể thay.</em></p>

...
Ví dụ agent có quyền gọi một API staging không có nghĩa nó cần đọc mọi file trong thư mục cá nhân. Agent được phép push nhánh cũng không có nghĩa nó được merge.

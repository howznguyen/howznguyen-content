...
Nghe thì tiện. Một câu thôi. Agent tự đọc <TermNote id="repository">repo</TermNote>, tự hiểu kiến trúc tổng thể, tự viết backend, tự làm frontend, tự viết test. Nếu làm được thì quá ngon.

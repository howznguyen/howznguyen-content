...
**Persistent memory** (bộ nhớ lâu dài) - thông tin được lưu lại giữa các session. Ví dụ: agent có thể nhớ preference của bạn, convention của project hoặc quyết định đã chốt. Lần sau mở lại, mình đỡ phải kể lại từ chương một.

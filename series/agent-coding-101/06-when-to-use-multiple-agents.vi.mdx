...
**Tìm hiểu nhiều vùng codebase** là ví dụ dễ nhất. Một agent phụ tìm cách project xử lý auth, một agent đọc flow email, một agent tìm test fixture. Mỗi agent trả về phát hiện có file tham chiếu. Agent chính không cần ôm toàn bộ log tìm kiếm của cả ba.
...
- Xác định chuyện thử lại, tính idempotent và quy ước mẫu email
